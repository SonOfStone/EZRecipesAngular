...
@Component({
  selector: 'app-realhome',
  templateUrl: './realhome.component.html',
  styleUrls: ['./realhome.component.css']
})
...
meals:any;
 ...
 console.log(this.rname);
    ...
    this.http.mymethod(HomeComponent.homename).subscribe(
      data=>{  
        this.brews=data;
        console.log("You have returned the data"+this.brews);
        for(let x in data){
          console.log("we got the ressults");
          console.log(x);
        }
 ...
 this.the8stingrediant2=this.brews.meals[2].strIngredient8;
  ...
  countClick1(){
    ...
    console.log(this.rname);
    console.log(this.rname);
    HomeComponent.homename=this.brews.meals[0].strMeal;
    ...
    countClick2(){
      ...
      console.log(this.rname);
      HomeComponent.homename=this.brews.meals[1].strMeal;
      this.http.mymethod(this.rname).subscribe();
      ...
      countClick3(){
        ...
        console.log(this.rname);
        HomeComponent.homename=this.brews.meals[2].strMeal;
        this.http.mymethod(this.rname).subscribe();
